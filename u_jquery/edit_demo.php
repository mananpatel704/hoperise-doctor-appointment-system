...
if(isset($_POST['submit']))
{
    ...
    $query=mysqli_query($conn,"update student_s set student_name='$student_name',student_email='$student_email',student_number=$student_number,student_address='$student_address' where student_id=$student_id");
    if($query)
    {
...
<body>
    ...
    student_number<input type="text" name="student_number" value="<?php echo $student_row['student_number'];?>"><br>
    student_address<textarea name="student_address"><?php echo $student_row['student_address'];?></textarea><Br>
