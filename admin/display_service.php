                    ...
                    <div class="ibox-body anyClass">
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                $category_data=mysqli_query($conn,"select * from hs_category where category_id=$service_row[category_id]");
                                $category_row=mysqli_fetch_array($category_data);

                                $sub_category_data=mysqli_query($conn,"select * from hs_sub_category where sub_category_id=$service_row[sub_category_id]");
                                ...
                                <tr>
                                    ...
                                    <td><img src="uploads/<?php echo $service_row['service_thumb'];?>"/></td>
                                    <td><a href="edit_service.php?service_id=<?php echo $service_row['service_id'];?>"><i class="fa fa-edit"></a></td>
                                    <td><a href="delete_service.php?service_id=<?php echo $service_row['service_id'];?>"><i class="fa fa-trash" aria-hidden="true"></a></td>
