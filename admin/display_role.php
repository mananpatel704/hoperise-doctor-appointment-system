    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-content fade-in-up">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">All Role</div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="edit_role.php?role_id=<?php echo $role_row['role_id'];?>"><i class="fa fa-edit"></i></a></td>
                                    <td><a href="delete_role.php?role_id=<?php echo $role_row['role_id'];?>"><i class="fa fa-trash" aria-hidden="true"></a></td>
