                ...
                <div class="ibox">
                    ...
                    <div class="ibox-body anyClass">
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php
                                $appoinment_data=mysqli_query($conn,"select * from hs_appointment");
                                ...
                                <tr>
                                    ...
                                    <td><a href="edit_appoinment.php?appointment_id=<?php echo $appoinment_row['appointment_id'];?>"><i class="fa fa-edit"></a></td>
