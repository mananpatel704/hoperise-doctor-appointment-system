...

{
    ...
    // Get transaction information from URL 
        ...
        //     $sql_tr = "INSERT INTO `payments`(`item_number`,`txn_id`,`payment_gross`,`currency_code`,`payment_status`) VALUES ('$id','$tid','$pg','$cc','$pst')";
        //     $data_tr = mysqli_query($con,$sql_tr) or die('MySQL Error (Insert)'.mysqli_error($con));
        //     $row_tr = mysqli_fetch_array($data_tr);
        ...
        //     $sql_tr = "UPDATE `payments` SET `item_number`='$id',`txn_id`='$tid',`payment_gross`='$pg',`currency_code`='$cc',`payment_status`='$pst' WHERE `txn_id` = '$tid'";
            ...
            <div class="col-lg-12">
                <div class="status">
                    <?php if(!empty($PayerID)){ ?>
                        ...
                        <br>
                        <p><b>Name : </b> <?php echo $id; ?></p>
                        <p><b>Price : </b> <?php echo $pg?></p>

                        <h4 class="heading">Date & Time</h4>
                        <p><b>Pay Date : </b> <?php echo "March 2, 2025"; ?></p>
