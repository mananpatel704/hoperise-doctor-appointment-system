<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $email_query=mysqli_query($conn,"select * from hs_patient_reg where patient_email='$patient_email'");
    ...
    <div class="content">
        ...
        <form action=" " method="post">
            ...
            <div class="form-group">
                <input class="form-control" type="email" name="patient_email" placeholder="Email" autocomplete="off">
            </div>
            <div class="form-group">
