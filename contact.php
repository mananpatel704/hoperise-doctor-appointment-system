<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $hs_email=$_POST['hs_email'];
        $hs_phone=$_POST['hs_phone'];
        $hs_message=$_POST['hs_message'];
         $query=mysqli_query($conn,"insert into hs_contact(hs_name,hs_email,hs_phone,hs_message)values('$hs_name','$hs_email','$hs_phone','$hs_message')");
         if($query)
         {
		...
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%;" class="list-item"><table align="center" border="0" cellspacing="0" cellpadding="0" style="width: inherit; margin: 0; padding: 0; border-collapse: collapse; border-spacing: 0;">
			...
			<tr>
				...
				<td align="left" valign="top" style="font-size: 17px; font-weight: 400; line-height: 160%; border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;
					...
					color: #000000;
					font-family: sans-serif;" class="paragraph">
						<b style="color: #333333;">Message:</b><br/>
						'.$hs_message.'
                ...
                <div class="address-block">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h3>Location</h3>
                            <p>401, SOLARIS ROYCE, Opp. OLD RTO & Surat District co-op bank, 
                                <br>Besides Vanita vishram ground.</p>
                        </div>
                    </div>
                    <!-- Phone -->
                    <div class="media">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h3>Email</h3>
                            <p>
							sapnnna988@gmail.com
							<br>Support@hoperise.com
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-8">
                <div class="contact-form">
                    ...
                    <form action="" class="row" method="post">
                        <!-- name -->
                        <div class="col-md-6">
                            <input type="text" name="hs_name" class="form-control main" placeholder="Name" required>
                        </div>
                        <!-- email -->
                        <div class="col-md-6">
                            <input type="email" class="form-control main"name="hs_email" placeholder="Email" required>
                        </div>
                        <!-- phone -->
                        <div class="col-md-12">
                            <input type="text" class="form-control main"name="hs_phone" placeholder="Phone" required>
                        </div>
                        <!-- message -->
                        <div class="col-md-12">
                            <textarea rows="15" class="form-control main"name="hs_message" placeholder="Your message"></textarea>
                        </div>
                        <!-- submit button -->
